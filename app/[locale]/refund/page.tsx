            ...
            <section key={num} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
              ...
              {num === 7 && (
                <div className="mt-4 space-y-2">
                  <p className="text-gray-700 dark:text-gray-300">{t('section7.email')}</p>
                  <p className="text-gray-700 dark:text-gray-300">{t('section7.address')}</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm mt-2">{t('section7.note')}</p>
                </div>
              )}
            </section>
          ))}
